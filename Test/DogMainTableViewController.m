//
//  DogMainTableViewController.m
//  Test
//
//  Created by Edward Jo on 11/25/13.
//  Copyright (c) 2013 Mark Tran. All rights reserved.
//

#import "DogMainTableViewController.h"
...
@interface DogMainTableViewController ()
...
@implementation DogMainTableViewController
...
- (void)viewDidLoad
{
    ...
    NSMutableDictionary *itemOne = [@{ kTitleKey : @"Reservation Request Date:" } mutableCopy];
    NSMutableDictionary *itemTwo = [@{ kTitleKey : @"Start Date",
                                       kDateKey : [NSDate date] } mutableCopy];
    NSMutableDictionary *itemThree = [@{ kTitleKey : @"End Date",
                                         kDateKey : [NSDate date] } mutableCopy];
    NSMutableDictionary *itemFour = [@{ kTitleKey : @"(other item)" } mutableCopy];
